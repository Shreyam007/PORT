    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#020005] flex-col overflow-hidden">
      <div className="relative flex items-center justify-center">
        ...
        <div 
          ...
          style={{ 
            background: 'conic-gradient(from 0deg, transparent 0%, #a855f7 40%, transparent 100%)', 
            filter: 'blur(8px)',
        ...
        <div 
          ...
          style={{ 
            background: 'conic-gradient(from 180deg, transparent 0%, #ec4899 40%, transparent 100%)', 
            filter: 'blur(12px)', 
            opacity: 0.8,
