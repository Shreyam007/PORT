            ...
            <RevealOnScroll delay={0} className="lg:col-span-2">
              <div className="h-full flex flex-col justify-center gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <h4 className="text-white font-outfit font-semibold text-sm px-1">Socials</h4>
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-4 glass rounded-2xl p-4 hover:border-blue-500/40 transition-colors group"
                      style={{ borderColor: 'rgba(255,255,255,0.06)' }}
                    >
                      <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110"
                        style={{ background: 'rgba(59,130,246,0.15)' }}>
                      ...
                      <div>
                        <p className="text-white font-outfit font-semibold text-sm">LinkedIn</p>
                        <p className="text-gray-500 font-outfit text-xs">shreyam-pandey</p>
                      </div>
                    </a>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-4 glass rounded-2xl p-4 hover:border-white/20 transition-colors group"
                      style={{ borderColor: 'rgba(255,255,255,0.06)' }}
                    >
                      <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110"
                      ...
                      <div>
                        <p className="text-white font-outfit font-semibold text-sm">GitHub</p>
                        <p className="text-gray-500 font-outfit text-xs">Shreyam007</p>
                      </div>
                    </a>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-4 glass rounded-2xl p-4 hover:border-pink-500/40 transition-colors group"
                      style={{ borderColor: 'rgba(255,255,255,0.06)' }}
                    >
                      <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110"
                      ...
                      <div>
                        <p className="text-white font-outfit font-semibold text-sm">Instagram</p>
                        <p className="text-gray-500 font-outfit text-xs">shrey4m_001</p>
                      </div>
                    </a>
                  </div>
                </div>
